...
$(document).ready(function () {
  ...
  $('.sodar-ss-checkbox-item').change(function () {
    let checkedCheckboxes = $('.sodar-ss-checkbox-item:checked')
    ...
    if (checkedCheckboxes.length < $('.sodar-ss-checkbox-item')
      .length) {
...
function sendRequest(url) {
  let checkboxes = document.querySelectorAll('.sodar-checkbox')
