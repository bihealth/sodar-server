...
describe('AssayShortcutCard.vue', () => {
  ...
  it('renders assay shortcuts', () => {
    ...
    expect(wrapper.findAll('.sodar-irods-ticket-access-1-btn').at(0)).not.toContain('disabled')
  })
  ...
  it('renders extra assay plugin shortcut', () => {
    ...
    expect(wrapper.findAll('.sodar-ss-vue-assay-shortcut').length).toBe(4)
  ...
  it('renders disabled shortcuts', () => {
    ...
    expect(wrapper.findAll('.sodar-vue-popup-list-btn').at(2).exists()).toBe(true)
