# NOTE: This is a "fork" of the django-test-plus 1.40 using TransactionTestCase
# Originally from SODAR Core<=0.11
...
from test_plus.compat import reverse, NoReverseMatch, get_api_client
