# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-08 13:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='protocol',
            name='json_id',
            field=models.CharField(blank=True, help_text='JSON @id value', max_length=255, null=True),
        ),
        ...
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='Characteristic categories'),
        ),
        migrations.AddField(
            model_name='assay',
            name='unit_cat',
            field=django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='Unit categories'),
        ),
        migrations.AlterUniqueTogether(
            name='assay',
        ...
        migrations.AddField(
            model_name='investigation',
            name='description',
            field=models.TextField(blank=True, help_text='Investigation description (optional, can be derived from project)', null=True),
        ),
        migrations.AddField(
            model_name='investigation',
            name='title',
            field=models.CharField(blank=True, help_text='Title (optional, can be derived from project)', max_length=255, null=True),
        ),
        ...
        migrations.AlterField(
            model_name='study',
            name='description',
            field=models.TextField(blank=True, help_text='Study description (optional)'),
        ),
        migrations.AlterField(
            model_name='study',
            name='title',
            field=models.CharField(blank=True, help_text='Title of the study (optional)', max_length=255),
        ),
        migrations.AlterModelOptions(
            name='genericmaterial',
        ...
        migrations.AddField(
            model_name='process',
            name='perform_date',
            field=models.DateField(help_text='Process performing date (optional)', null=True),
        ),
        migrations.AlterField(
            model_name='process',
            name='name',
            field=models.CharField(blank=True, help_text='Process name (optional)', max_length=255, null=True),
        ),
        migrations.AlterUniqueTogether(
            name='process',
            unique_together=set([]),
        ...
        migrations.AlterField(
            model_name='genericmaterial',
            name='study',
            field=models.ForeignKey(help_text='Study to which the material belongs', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='materials', to='samplesheets.Study'),
        ),
        migrations.AlterField(
            model_name='process',
