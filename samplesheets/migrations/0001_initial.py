# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-14 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_id', models.CharField(blank=True, help_text='ISA API object id', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_process', models.ForeignKey(help_text='Next process (can be None for the last process in sequence)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='previous', to='samplesheets.Process')),
                ...
                ('previous_process', models.ForeignKey(help_text='Previous process (can be None for first process in sequence)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='next', to='samplesheets.Process')),
            ],
            options={
